...
router.post('/:id/detail', auth, async (req, res) => {
  try {
    ...
    const competitors = [
      { nmID: '12345678', name: 'Кроссовки Nike', price: 5990, position: 1, clusters: ['Беговые кроссовки', 'Спорт'] },
      { nmID: '87654321', name: 'Кроссовки Adidas', price: 6990, position: 2, clusters: ['Беговые кроссовки', 'Спорт'] },
      { nmID: '11223344', name: 'Кроссовки Puma', price: 4990, position: 3, clusters: ['Беговые кроссовки'] }
    ];
